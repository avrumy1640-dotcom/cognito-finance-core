...
export const AdminAccounts = () => (
  <AdminPage>
    <AdminHeader
      title="Accounts"
      subtitle="Bank accounts across all customers, sourced from Iberbanco."
    />
    <div className="rounded-xl border border-border bg-card p-6 text-sm text-muted-foreground">
      Account-level data is fetched on demand via the Iberbanco proxy. Use the Customers tab to drill
...
export const AdminCrypto = () => (
  <AdminPage>
    ...
    <div className="rounded-xl border border-border bg-card p-6 text-sm text-muted-foreground">
      Crypto wallets are provisioned through Iberbanco once the customer opts in. This surface will
...
export const AdminExchange = () => (
  <AdminPage>
    ...
    <div className="rounded-xl border border-border bg-card p-6 text-sm text-muted-foreground">
      Live FX rates come from the Iberbanco exchange endpoint. Customer orders will appear here
